    ...
    (function (t, e) {
        ...
        (s.log = function (t, e) {
            ...
            (s.updateGetPath = function () {
                ...
                var e = typeof t;
                if (e == "function") return void (this.getPath = t);
                var i = e == "string" && t.match("{{#}}");
                return i
    ...
    (function (t, e) {
        ...
        function r(t, e, i, n, o) {
            ...
            r.open("GET", t, !0),
                ...
                (r.onload = function () {
                    if (r.status == 200) i(r.response);
                    else if (r.status == 204) o(r.response);
                    else {
        ...
        return (
            ...
            (s.appendNextPage = function (t, e) {
                var n = this.options.append,
                    o = this.options.responseType == "document";
                if (o && n) {
