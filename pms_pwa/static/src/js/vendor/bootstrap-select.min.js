    ...
    !(function (z) {
        ...
        var I,
            ...
            S =
                ...
                function (e) {
                    return (
                        (e = null == e ? "" : "" + e), y.test(e) ? e.replace($, E) : e
                    );
                });
        function E(e) {
            return I[e];
        ...
        function Z(e) {
            ...
            var s = this.each(function () {
                ...
                if (e.is("select")) {
                    ...
                    "string" == typeof c &&
                        (l =
                            t[c] instanceof Function ? t[c].apply(t, a) : t.options[c]);
                }
            });
            return void 0 !== l ? l : s;
        }
            ...
            (Y.prototype = {
                ...
                createView: function (A, e, t) {
                    ...
                    function l(e, t) {
                                    ...
                                    ? ((v =
                                      ...
                                      (g =
                                          D.selectpicker.view.position1 > d - 1
                                              ? 0
                                              : D.selectpicker.current.data[d - 1]
                                                    .position -
                                                D.selectpicker.current.data[
                        ...
                        if (
                            ((D.prevActiveIndex = D.activeIndex), D.options.liveSearch)
                        ) {
                            if (A && t) {
                                var z,
                                    T = 0;
                ...
                liHeight: function (e) {
                    if (
                        ...
                        if (
                            ...
                            (t.className =
                                this.$menu[0].parentNode.className + " " + V.SHOW),
                            (t.style.width = 0),
                        ...
                        var v,
                            ...
                            C = {
                                ...
                                horiz:
                                    ...
                                    L(
                                        $ ? $.borderLeftWidth : E.css("borderLeftWidth")
                                    ) +
                                    L(
                                        $
                                            ? $.borderRightWidth
                ...
                setMenuSize: function (e) {
                    ...
                    if (
                        (this.options.dropupAuto &&
                            ((l =
                                d * this.selectpicker.current.elements.length + v.vert),
                            (a =
                                this.sizeInfo.selectOffsetTop -
                                    this.sizeInfo.selectOffsetBot >
                                    ...
                                    if (
                                        ...
                                        if ((v && b) || (g && w))
                                            if (v && 1 == v)
                                                ...
                                                var k =
                                                        "string" ==
                                                        typeof C.options.maxOptionsText
                                                            ? [
                                                                  C.options
                                                                      .maxOptionsText,
                                                                  C.options
                ...
                keydown: function (e) {
                    var t,
                        ...
                        a = (l ? r.closest(".dropdown") : r.closest(F.MENU)).data(
                            "this"
                        ),
                        c = a.findLis(),
                        d = !1,
                            ...
                            if (
                                ...
                                -1 !==
                                    ...
                                    e.which === B
                                        ...
                                        : (e.which !== M && !h) ||
                                          (++t + f >=
                                              a.selectpicker.view.canHighlight.length &&
                                              (t = 0),
                                          a.selectpicker.view.canHighlight[t + f] ||
                                              (t =
                                                  t +
                                ...
                                e.which === B
                                    ? 0 === f && t === c.length - 1
                                        ? ((a.$menuInner[0].scrollTop =
                                          ...
                                          (m =
                                              a.selectpicker.current.elements.length -
                                              1))
                                        : (d =
                                              (o =
                                                  (n = a.selectpicker.current.data[m])
                                                      .position - n.height) < u)
                                    : (e.which !== M && !h) ||
                                      (0 === t
