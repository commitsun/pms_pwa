...
class PmsReservation(models.Model):
    ...
    def _compute_partner_image_128(self):
        for record in self:
            ...
            elif record.partner_name and (not record.partner_image_128 or record.image_autogenerated):
    ...
    @api.model
    def pwa_action_checkin(self, checkin_partner_list, reservation_id, action_on_board=False):
